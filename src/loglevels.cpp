...
namespace g3 {
   namespace internal {
      ...
      std::map<int, atomicbool> g_log_level_status = {{g3::kDebugValue, true}, {INFO.value, true}, {WARNING.value, true},{ ERRORS.value, true }, {FATAL.value, true}};
#endif
   } // internal
   ...
   namespace only_change_at_initialization {
      ...
      void reset() {
         ...
         internal::g_log_level_status = std::map<int, atomicbool>{{g3::kDebugValue, true}, {INFO.value, true}, {WARNING.value, true},{ ERRORS.value, true }, {FATAL.value, true}};
      }
